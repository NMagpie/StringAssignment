...
Console.WriteLine($"Number of Words: {textSplitted.Length}\n");

//- Display the sentence count of this string

var textSplittedBySentences = text.Split('.');

Console.WriteLine($"Number of Sentences: {textSplittedBySentences.Length}\n");
...
{
    if ( word.Contains("encapsulation", StringComparison.CurrentCultureIgnoreCase) )
        wordCounter++;
}

Console.WriteLine($"Number of occurences of the word \"encapsulation\": {wordCounter}\n");
...
var replacedString = text.Replace("object-oriented programming", "OOP");

Console.WriteLine($"Replaced with OOP:\n {replacedString}");